...
This project was initially born as a modern (and [more performant](/guides/performances)) replacement for [react-reveal](https://github.com/rnosov/react-reveal), which has been discontinued.
