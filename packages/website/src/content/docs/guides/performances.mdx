...
At the same time, it is flexible enough to let you implement custom animations by using the generic `Reveal` primitive. Refer to the [Custom Animations](/guides/custom-animations) guide to know more.
