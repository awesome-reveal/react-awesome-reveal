...
It works by assigning a progressive delay to each direct child wrapped by an animated primitive &mdash; this is particularly useful for animating list items.
